...
lifestyle_button = Button(frame1, text="Lifestyle", font=font, bg="white", fg="black", padx=15, pady=5, width=13)
...
label_trending = Label(frame2, text="Lifestyle", font=('Arial', 25),)
label_trending.pack()
