...
img_home = load_image("Image/home.png",100, 90)
button_home = Button(frame_button, image=img_home, bd=0, highlightthickness=0)
button_home.grid(row=0, column=0, padx=65, pady=10)

empty_space1 = Label(frame_button)
empty_space1.grid(row=0, column=1, padx=530)

img_summary = load_image("Image/summary.png",100, 90)
button_summary = Button(frame_button, image=img_summary, bd=0, highlightthickness=0)
...
text_label = Label(frame_text, text=long_text, font=('Arial', 14), wraplength=900, justify="left")
text_label.pack()
